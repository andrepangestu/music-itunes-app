...
import { useGetItunes } from "../../hooks/useGetItunes";
  ...
  return (
    <div className="w-full">
      ...
      >
        ...
        <button className="h-full flex" onClick={() => setIsSearch(true)}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
      ...
      {search ? (
        <section>
          <div className="mt-[42px] flex flex-row justify-center items-center">
            <span className="text-sm text-slate-700 mr-[14px]">
              Search result for :
            </span>
              ...
              >
                ...
                <div className="flex flex-col flex-1 pt-1 pl-3 pr-0.5 justify-between">
                  <div className="flex-1 h-full">
                    <h4 className="text-[10px] leading-3 text-slate-700 font-medium">
                      {item.artistName}
                    </h4>
                    <h3 className="mt-1 mb-3 text-sm font-bold text-slate-700">
        ...
        <section>
          <p className="text-center p-4">
            Please, click button search to find your music
          </p>
        </section>
      )}
